      ...
      <div className="home-content">
        <div className="label-main">
          ...
          <p className="description-label">
            Data engineer with a MEng. in Computer Science from the University
            of Connecticut. Experience with building and maintaining data
            pipelines and analyzing data from various sources. Continuous
